...
SWEP.AttachmentElements = {
    ...
    ["rail"] = {
        VMBodygroups = {{ind = 6, bg = 1},{ind = 5, bg = 1}},
    },
...
SWEP.Attachments = {
    {
        ...
        Bone = "smdimport",
        Offset = {
            vpos = Vector(-0.1, -1, 2.5),
            vang = Angle(0, -90.3, 0),
        },
        CorrectiveAng = Angle( 0, 180.3, 0 ),
        InstalledEles = {"rail"},
    },
    {
        PrintName = "Muzzle",
    ...
    },
    {
        ...
        Bone = "Body",
        DefaultAttIcon = Material("entities/att/acwatt_ba_g3_barrel_default.png", "smooth mips"),
        Offset = {
...

    {
        ...
        Bone = "Body",
        DefaultAttIcon = Material("entities/att/acwatt_ba_g3_stock_default.png", "smooth mips"),
        Offset = {
            vpos = Vector(0.048, 0.2, 11),
            vang = Angle(90, 0, -90),
        },
...

    {
        ...
        DefaultAttIcon = Material("entities/att/acwatt_ba_g3_mag_20.png", "smooth mips"),
        Bone = "Body",
        Offset = {
            vpos = Vector(0.048, 0.2, 11),
            vang = Angle(90, 0, -90),
