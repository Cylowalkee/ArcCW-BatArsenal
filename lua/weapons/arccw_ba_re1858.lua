...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "rotation controller",
        DefaultAttIcon = Material("entities/att/acwatt_ba_re1858_barrel_normal.png", "smooth mips"),
        Offset = {
...

    {
        ...
        DefaultAttIcon = Material("entities/att/acwatt_ba_re1858_grip_normal.png", "smooth mips"),
        Bone = "rotation controller",
        Offset = {
            vpos = Vector(0.048, 0.2, 11),
            vang = Angle(90, 0, -90),
