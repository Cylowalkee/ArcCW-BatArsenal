...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "Gun",
        DefaultAttIcon = Material("entities/att/acwatt_ba_m24_barrel_default.png", "smooth mips"),
    },
    {
        ...
        Bone = "Gun",
        DefaultAttIcon = Material("entities/att/acwatt_ba_m24_stock_default.png", "smooth mips"),
    },
    {
        PrintName = "Magazine",
        Slot = {"ba_m24_mag"},
        ...
        Bone = "Gun",
        DefaultAttIcon = Material("entities/att/acwatt_ba_m24_mag_10.png", "smooth mips"),
    },
    {
        PrintName = "Ammo Type",
        Slot = "ba_ammo_bullet",
